...
import { FaEye, FaPrint, FaSearch, FaTrash } from "react-icons/fa";
import { createFiche, deleteFiche, getFiches, toggleStateFiche, updateFiche } from "../services/ficheservice";
...
function Fiches() {
  ...
  const statusTemplate = (row) => <Switch checked={row.isOpen} onChange={(e) => handleChangeState(e.currentTarget.checked,row._id)} />;
   ...
   return (
    <>
    <LoadingOverlay visible={loadingT || isLoading} zIndex={1000} overlayProps={{ radius: 'sm', blur: 2 }}
