...
import { getAttributionGlobalesByEmploye } from '../services/attribution-globalservice';

function AttributionsGlobalesEmploye({id}) {
    ...
    const qk = ['get_AttributionGlobaleEmploye',id]

    const {data: AttributionGlobalesEmploye, isLoading } = useQuery(qk, () => getAttributionGlobalesByEmploye(id));
  ...
  <LoadingOverlay visible={isLoading || isLoadingR} overlayProps={{ radius: 'sm', blur: 2 }} loaderProps={{ color: 'blue', type: 'bars' }} />
    ...
    <div className="datatable-doc">
         <div className="card p-4">
             <DataTable value={AttributionGlobalesEmploye} paginator className="p-datatable-customers" header={header} rows={10}
...
export default AttributionsGlobalesEmploye