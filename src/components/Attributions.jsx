...
import AttributionsFonctionnellesEmploye from "./AttributionsFonctionnellesEmploye"
...
const [tabs] = useState(['ATTRIBUTIONS GLOBALES', 'ATTRIBUTIONS FONCTIONNELLES','ATTRIBUTIONS INDIVIDUELLES'])
  return (
  ...
  <Pane padding={16} background="tint1" flex="1">
      ...
      <Pane
        ...
        role="tabpanel"
      >
        {id && <AttributionsFonctionnellesEmploye id={id}/>}
      </Pane>
      <Pane
