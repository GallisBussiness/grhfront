...
import { createAttributionglobale, getAttributionglobales, removeAttributionGlobale, updateAttributionglobale } from '../../services/attribution-globalservice';
...
function Attributionglobales() {
  const [rubriques,setRubriques] = useState([]);
    ...
    const {mutate: supprimer,isLoading:isLoadingde} = useMutation((id) => removeAttributionGlobale(id), {
      onSuccess: (_) => {
          notifications.show({
              title: 'SUPPRESSION',
