...
const schema = yup
  ...
  .required();
   ...
   const CreateCddModal = ({ isOpen, onResolve, onReject }) =>{
  const defaultValues = {
    prenom: "",
    nom: "",
    nci: "",
            ...
            <div>
             ...
             <div className="flex flex-col space-y-1 w-full">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                         <DateInput onChange={field.onChange} value={field.value} placeholder="Date de Fin de contrat" label="DATE DE FIN DE CONTRAT" error={errors.date_de_fin_de_contrat && errors.date_de_fin_de_contrat.message} locale={fr}/>
                        )}
                      />
                    </div>
                    <div>
  ...
  export default create(CreateCddModal)