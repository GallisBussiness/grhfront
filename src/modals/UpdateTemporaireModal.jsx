...
function UpdateTemporaireModal({temp, isOpen, onResolve, onReject }) {
  ...
  const defaultValues = {
    ...
    nom: temp?.nom,
    nci: temp?.nci,
    status: temp?.status?._id,
    genre: temp?.genre,
    mensualite: temp?.mensualite,
  };
...
export default create(UpdateTemporaireModal)